...
<style id="app-shell-overrides">
  ...
  /* CPU / MEM / GPU tiles — a little bigger and easier to read at a glance. */
  #resting .minibar { padding:11px 6px !important; border-radius:10px !important; }
  #resting .minibar .v { font-size:15px !important; }
  #resting .minibar .k { font-size:8.5px !important; margin-top:3px !important;
