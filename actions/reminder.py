...
def _scripts_dir() -> Path:
    ...
    try:
        ...
        print(f"[reminder.py] Non-fatal error at line 38: {_e}")
...
try:
    ...
    notification.notify(title="Aethelark Reminder", message=message, timeout=15)
    notified = True
except Exception as _e:
    print(f"[reminder.py] Non-fatal error at line 67: {_e}")

if not notified:
    try:
        from win10toast import ToastNotifier
        ToastNotifier().show_toast("Aethelark Reminder", message, duration=15, threaded=False)
        notified = True
    except Exception as _e:
        print(f"[reminder.py] Non-fatal error at line 75: {_e}")
...
try:
    ...
    print(f"[reminder.py] Non-fatal error at line 90: {_e}")
"""
...
try:
    ...
    print(f"[reminder.py] Non-fatal error at line 103: {_e}")
...
try:
    ...
    print(f"[reminder.py] Non-fatal error at line 126: {_e}")
...
if not notified:
    try:
        ...
        print(f"[reminder.py] Non-fatal error at line 137: {_e}")
"""

    script_body = f"""# Auto-generated by Aethelark reminder — do not edit
...
try:
    ...
    print(f"[reminder.py] Non-fatal error at line 147: {_e}")
"""
...
def _schedule_windows(target_dt: datetime, task_name: str,
    ...
    try:
        ...
        print(f"[reminder.py] Non-fatal error at line 198: {_e}")
...
def reminder(
    ...
    task_name  = f"AethelarkReminder_{target_dt.strftime('%Y%m%d_%H%M%S')}"
