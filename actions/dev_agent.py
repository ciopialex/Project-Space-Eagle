...
PROJECTS_DIR     = (_LEGACY_PROJECTS if _LEGACY_PROJECTS.exists()
                    else Path.home() / "Desktop" / "AethelarkProjects")
MAX_FIX_ATTEMPTS = 5
...
def _build_project(
    ...
    proj_name    = project_name or plan.get("project_name", "aethelark_project")
